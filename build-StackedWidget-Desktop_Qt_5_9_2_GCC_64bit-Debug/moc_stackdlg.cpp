...
struct qt_meta_stringdata_StackDlg_t {
    QByteArrayData data[1];
    char stringdata0[9];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_StackDlg_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_StackDlg_t qt_meta_stringdata_StackDlg = {
    {
QT_MOC_LITERAL(0, 0, 8) // "StackDlg"
...
const QMetaObject StackDlg::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_StackDlg.data,
      qt_meta_data_StackDlg,  qt_static_metacall, nullptr, nullptr}
};
...
void *StackDlg::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_StackDlg.stringdata0))
